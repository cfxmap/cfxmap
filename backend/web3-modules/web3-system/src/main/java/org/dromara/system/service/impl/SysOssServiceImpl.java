...
public class SysOssServiceImpl implements ISysOssService, OssService {
    ...
    public SysOssVo upload(MultipartFile file) {
        ...
        String suffix = resolveMultipartSuffix(file);
    ...
    public SysOssVo upload(File file) {
        ...
        String suffix = (dot > 0 && dot < originalfileName.length() - 1)
    ...
    /**
     * Linux 等环境下 multipart 临时文件常无扩展名；lastIndexOf 为 -1 时不可用 Hutool sub 截取后缀。
     */
    private static String resolveMultipartSuffix(MultipartFile file) {
        ...
        return inferDotSuffixFromContentType(file.getContentType());
    }

    private static String inferDotSuffixFromContentType(String contentType) {
        ...
        if (ct.contains("image/heic") || ct.contains("image/heif")) {
            return ".heic";
        }
        if (ct.contains("image/bmp") || ct.contains("image/x-ms-bmp")) {
            return ".bmp";
        }
        if (ct.contains("jpeg") || ct.contains("image/jpg")) {
            return ".jpg";
        }
        if (ct.contains("png")) {
            return ".png";
